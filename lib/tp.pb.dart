...
class Match extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(9)
  set defaulfPrediction($core.String v) {
    $_setString(8, v);
  }
  ...
  @$pb.TagNumber(10)
  $core.String get defaultOdds => $_getSZ(9);
  @$pb.TagNumber(10)
  set defaultOdds($core.String v) {
    $_setString(9, v);
  }
...
class MobileBet extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(6)
  $core.bool get showReslut => $_getBF(5);
  @$pb.TagNumber(6)
  set showReslut($core.bool v) {
    $_setBool(5, v);
  }

  @$pb.TagNumber(6)
  $core.bool hasShowReslut() => $_has(5);
  @$pb.TagNumber(6)
  void clearShowReslut() => clearField(6);
}
