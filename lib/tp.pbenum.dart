...
class IsWin extends $pb.ProtobufEnum {
  static const IsWin WON = IsWin._(0, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'WON');
  static const IsWin UNKNOWN = IsWin._(1, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'UNKNOWN');
  static const IsWin LOST = IsWin._(2, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'LOST');
